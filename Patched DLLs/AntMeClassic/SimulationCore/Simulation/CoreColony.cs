        ...
        internal CoreColony(CorePlayground spielfeld, PlayerInfo spieler, CoreTeam team) {
            ...
            foreach (CasteInfo caste in spieler.Castes)
            {
                ...
                */
                ...
                GeschwindigkeitI[index] = SimulationEnvironment.PLAYGROUND_UNIT;
                GeschwindigkeitI[index] *= SimulationSettings.Default.CasteSettings[caste.Speed].Speed;
                Drehgeschwindigkeit[index] = SimulationSettings.Default.CasteSettings[caste.RotationSpeed].RotationSpeed;
                Last[index] = SimulationSettings.Default.CasteSettings[caste.Load].Load;
                SichtweiteI[index] = SimulationEnvironment.PLAYGROUND_UNIT;
                SichtweiteI[index] *= SimulationSettings.Default.CasteSettings[caste.ViewRange].ViewRange;
                ReichweiteI[index] = SimulationEnvironment.PLAYGROUND_UNIT;
                ReichweiteI[index] *= SimulationSettings.Default.CasteSettings[caste.Range].Range;
                Energie[index] = SimulationSettings.Default.CasteSettings[caste.Energy].Energy;
                Angriff[index] = SimulationSettings.Default.CasteSettings[caste.Attack].Attack;
