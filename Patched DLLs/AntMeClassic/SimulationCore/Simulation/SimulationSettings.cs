...
namespace AntMe.Simulation {
    ...
    public struct SimulationSettings {
        ...
        public void SetDefaults() {
            ...
            CasteSettings.Columns = new SimulationCasteSettingsColumn[5];
            ...
            CasteSettings.Columns[4].Attack = 5000;
            CasteSettings.Columns[4].Energy = 90000;
            CasteSettings.Columns[4].Load = 100;
            CasteSettings.Columns[4].Range = 20000;
            CasteSettings.Columns[4].RotationSpeed = 16;
            CasteSettings.Columns[4].Speed = 6;
            CasteSettings.Columns[4].ViewRange = 90;
        }
